...
const Card = (props) => {
    return (
        ...
        <a href={"https://github.com/topics/"+ "{props.repo}"}>geete</a>

        </div>
        <div className={styles.CardDetail}>geet

        </div>
        <div className={styles.CardTags}>
            <div className={styles.Tags}>  <a href={"https://github.com/topics/"+ "{props.tag}"}>geete</a> </div>
        </div>
        <div className={styles.Forks}>
            <div className={styles.ForksDetail}>
                ...
                <div className={styles.StarsCount}> 9000</div>
            </div>
            <div className={styles.ForksDetail}>
