    ...
    return (
        ...
        <div className={styles.Forks}>
            <div className={styles.ForksDetail}>
                ...
                <div className={styles.StarsCount}> {props.row.pull_request_count.pullRequestCount}</div>
            </div>
            <div className={styles.ForksDetail}>
                ...
                <div className={styles.StarsCount}> {props.row.pull_request_count.mergedPullRequestCount}</div>
            </div>
        </div>
